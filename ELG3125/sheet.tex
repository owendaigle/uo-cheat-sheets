...
\begin{document}
	...
	\section{Bode Plot}
	This is a way to graphically represent fourier transforms. If we want to plot $x(t)$, we can actually plot $20\log_{10} |X(\jmath \omega)|$ and we will get a straight line equation.
	...
	When finding bode plots, we want to get the equation into the form of:
	\begin{align*}
	...
	\begin{mdframed}
		\textbf{Ex.} Find the bode plot of the following: %from A7 about bode plot
		\begin{align*}
		...
		\begin{center}
			\includegraphics[width=0.4\linewidth]{"bode ex"}
		\end{center}
	...
	\begin{align}\label{eq:damping}
		H(\jmath\omega) = \frac{\omega^2}{(\jmath\omega_n)^2 + 2w_n \zeta (\jmath\omega) + \omega_n^2}
	\end{align}	
