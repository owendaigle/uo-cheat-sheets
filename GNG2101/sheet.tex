...
\begin{document}
	...
	When coming up with the solutions, we need to generate a large amount of them. Then we score these solutions using a decision matrix that contains different factors.
	\begin{table}[H]
		\centering
